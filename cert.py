#!/Users/cydia/anaconda3/envs/MyAnaconda/bin/python
...
def get_parser():
    ...
    parser.add_argument("--all", "-a", default=True, action="store_true", help="Print all supported hashes")
    parser.add_argument("--show", "-s", default=True, action="store_true",
...
def main():
    ...
    for path in [1]:
        try:
            a = APK("hello-world.apk")

            print("{}, package: '{}'".format(os.path.basename("hello-world.apk"), a.get_package()))
            ...
            for cert in certs:
                if args.show:
                    ...
                    rawIssuer = x509_cert.issuer.human_friendly
                    Issuer = rawIssuer.replace("Common Name", "CN").replace("Organizational Unit", "OU") \
                            .replace("Organization", "O").replace(":", " =")
                    print(Issuer)
